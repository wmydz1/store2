<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/admin/view2/order/ajaxdelivery.html";i:1495107356;}*/ ?>
<table>
 	<tbody>
	...
	<?php else: if(is_array($orderList) || $orderList instanceof \think\Collection || $orderList instanceof \think\Paginator): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
  		<tr>
             ...
             <td align="left" abbr="add_time" axis="col4" class="">
               <div style="text-align: left; width: 160px;" class=""><?php echo date('Y-m-d H:i',$list['add_time']); ?></div>
             </td>
             <td align="left" abbr="consignee" axis="col4" class="">
               <div style="text-align: left; width: 160px;" class=""><?php echo $list['consignee']; ?></div>
             </td>
             ...
             <td align="center" abbr="article_time" axis="col6" class="">
               <div style="text-align: center; width: 80px;" class=""><?php echo $list['shipping_price']; ?></div>
             </td>
             <td align="center" abbr="article_time" axis="col6" class="">
             ...
             <td align="center" abbr="article_time" axis="col6" class="">
               <div style="text-align: center; width: 120px;" class=""><?php echo $list['total_amount']; ?></div>
             </td>
