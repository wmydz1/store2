<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/order/delivery_list.html";i:1495107356;s:44:"./application/admin/view2/public/layout.html";i:1495107356;}*/ ?>
<!doctype html>
<html>
<head>
          ...
          <thead>
	        	<tr>
	              ...
	              <th align="left" abbr="order_sn" axis="col3" class="">
	                <div style="text-align: left; width: 160px;" class=""><a href="javascript:sort('order_sn');">订单编号</a></div>
	              </th>
	              <th align="left" abbr="add_time" axis="col4" class="">
	                <div style="text-align: left; width: 160px;" class=""><a href="javascript:sort('add_time');">下单时间</a></div>
	              </th>
	              ...
	              <th align="center" abbr="article_time" axis="col6" class="">
	                <div style="text-align: center; width: 80px;" class="">所选物流</div>
	              </th>
	              <th align="center" abbr="article_time" axis="col6" class="">
	                <div style="text-align: center; width: 80px;" class="">物流费用</div>
	              </th>
	              <th align="center" abbr="article_time" axis="col6" class="">
	                <div style="text-align: center; width: 160px;" class="">支付时间</div>
	              </th>
	              <th align="center" abbr="article_time" axis="col6" class="">
	                <div style="text-align: center; width: 120px;" class=""><a href="javascript:sort('total_amount');">订单总价</a></div>
	              </th>
