...
<div class="top-banner" id="top-banner-block">
    ...
    <?php $pid =1;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1510534800 and end_time > 1510534800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
      ...
      <div id="cata_list"> 
        ...
        <ul class="menu_3">
          ...
          <li class="menu_two">
            ...
            <?php if(is_array($v['sub_menu']) || $v['sub_menu'] instanceof \think\Collection || $v['sub_menu'] instanceof \think\Paginator): if( count($v['sub_menu'])==0 ) : echo "" ;else: foreach($v['sub_menu'] as $key=>$vv): ?>
    ...
    <?php
      ...
      <div class="hotitem">
        <div class="itemin">
          ...
          <p class="itemprice">
            <span class="new" rehot="90101748934_201480" style="display: block; float: left;"><i class="fn-rmb">¥</i><?php echo $v[shop_price]; ?></span>
            <span class="old"><i class="fn-rmb">¥</i><?php echo $v[market_price]; ?></span>
          </p>
        </div>
      </div>
     <?php endforeach; ?> 
...
<div class="cata_shop_right" id="tracker_category"> 
  ...
  <ul id="cata_choose_product" class="cart_containt clearfix listContainer">
    <?php if(is_array($goods_list) || $goods_list instanceof \think\Collection || $goods_list instanceof \think\Paginator): if( count($goods_list)==0 ) : echo "" ;else: foreach($goods_list as $k=>$v): ?>
      <li>
