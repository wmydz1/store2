<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view2/distribut/goods_list.html";i:1495107356;s:44:"./application/admin/view2/public/layout.html";i:1495107356;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <table>
                ...
                <?php if(is_array($goodsList) || $goodsList instanceof \think\Collection || $goodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                    <tr>
                        ...
                        <td align="center" axis="col0">
                            <div style="text-align: left; width: 200px;"><?php echo $catList[$list[cat_id]][name]; ?></div>
                        </td>
                        <td align="center" axis="col0">
                        ...
                        <td align="center" axis="col0">
                            <div style="text-align: center; width: 50px;"><?php echo $list['commission']; ?></div>
                        </td>
                        <td align="center" axis="col0">
                            <div style="text-align: center; width: 80px;"><?php echo round($list['commission']/$list['shop_price']*100,2); ?>%</div>
                        </td>
                        <td align="center" class="handle">
                            <div style="text-align: center; width: 170px; max-width:170px;">
                                ...
                                <a href="<?php echo U('Admin/Goods/addEditGoods',array('id'=>$list['goods_id'],'is_distribut'=>1)); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
