<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/admin/view2/user/ajaxindex.html";i:1495107356;}*/ ?>
    ...
    <table>
        ...
        <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr data-id="<?php echo $list['user_id']; ?>">
                ...
                <td align="left" class="">
                    <div style="text-align: center; width: 180px;"><?php echo $list['email']; if(($list['email_validated'] == 0) AND ($list['email'])): ?>
                            (未验证)
                        <?php endif; ?>
                    </div>
                </td>
                ...
                <td align="left" class="">
                    <div style="text-align: center; width: 130px;"><?php echo $list['mobile']; if(($list['mobile_validated'] == 0) AND ($list['mobile'])): ?>
                            (未验证)
                        <?php endif; ?>
                    </div>
                </td>
                ...
                <td align="center" class="handle">
                    <div style="text-align: center; width: 170px; max-width:170px;">
                        <a class="btn blue" href="<?php echo U('Admin/user/detail',array('id'=>$list['user_id'])); ?>"><i class="fa fa-pencil-square-o"></i>查看编辑</a>
                        <a class="btn blue" href="<?php echo U('Admin/user/account_log',array('id'=>$list['user_id'])); ?>"><i class="fa fa-search"></i>用户资金</a>
