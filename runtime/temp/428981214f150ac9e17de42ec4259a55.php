<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:38:"./template/pc/default/index/index.html";i:1495107366;s:40:"./template/pc/default/public/header.html";i:1495107366;s:44:"./template/pc/default/public/siteTopbar.html";i:1495107366;s:38:"./template/pc/default/public/kefu.html";i:1495107366;s:40:"./template/pc/default/public/footer.html";i:1495107366;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="top-banner" id="top-banner-block">
    ...
    <?php $pid =1;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1508590800 and end_time > 1508590800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
    	...
    	<div class="layout">
        	...
        	<div class="allgoods">
            	...
            	<div class="list" <?php if(MODULE_NAME.'/'.CONTROLLER_NAME.'/'.ACTION_NAME == 'home/Index/index') echo 'style="display:block;"'; ?> >
                   <ul class="list_ul"> 
                       <?php if(is_array($goods_category_tree) || $goods_category_tree instanceof \think\Collection || $goods_category_tree instanceof \think\Paginator): if( count($goods_category_tree)==0 ) : echo "" ;else: foreach($goods_category_tree as $k=>$v): if($v[level] == 1): ?>                       
                                <li class="list-li">
                                    <div class="list_a">
                                        ...
                                        <p> <!--$v[id][name] 数组中括号 里面的 id name 不能有 引号 sql 参数 必须双引号-->
	                                       <?php $index = '1'; if(is_array($v[tmenu]) || $v[tmenu] instanceof \think\Collection || $v[tmenu] instanceof \think\Paginator): if( count($v[tmenu])==0 ) : echo "" ;else: foreach($v[tmenu] as $k2=>$v2): if($v2[parent_id] == $v[id]): if($index++ > 3) break; ?>
                                    ...
                                    <div class="list_b">
                                        <div class="list_bigfl">
	                                       <?php $index = '1'; if(is_array($v[tmenu]) || $v[tmenu] instanceof \think\Collection || $v[tmenu] instanceof \think\Paginator): if( count($v[tmenu])==0 ) : echo "" ;else: foreach($v[tmenu] as $k2=>$v2): if($v2[parent_id] == $v[id]): if($index++ > 6) break; ?>
...
<!--------banner-开始-------------->
	<div class="nav-banner">
        <div id="banner_tabs" class="flexslider">
            ...
            <?php $pid =2;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1508590800 and end_time > 1508590800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
    ...
    <div class="layout">
    	...
    	<div class="bs-ri">
        	<div class="ris-adve"><!--公告上方广告位-->
                <?php $pid =7;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1508590800 and end_time > 1508590800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
        	...
        	<div class="ris-notice">
             ...
             <!--公告下方广告位-->
        	 <div class="ris-as"> 
                <?php $pid =8;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1508590800 and end_time > 1508590800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
<!--------中部banner-开始-------------->
	<div class="layout">
    	<div class="cen-banne">
            <?php $pid =3;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1508590800 and end_time > 1508590800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
<?php
                                ...
                                {                            
                                    ...
                                    S("sql_".$md5_key,$sql_result_val,1);
                                }    
        	...
        	<div class="flool-t">
                ...
                <?php
                                ...
                                {                            
                                    ...
                                    S("sql_".$md5_key,$sql_result_val2,1);
                                }    
...
<!--------底部banner-开始-------------->
	<div class="layout layer">
    	<div class="cen-banne">
            <?php $pid =4;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1508590800 and end_time > 1508590800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
