<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./template/pc/default/goods/ajaxComment.html";i:1495107366;}*/ ?>
        ...
        <div class="pro-user-comment-main ma-0-25-0-0 ov-hi">
            <div class="pro-user-comment">
                ...
                <div class="comm-t2">
                    ...
                    <!--商家回复-->                    
                    <?php if(is_array($replyList) || $replyList instanceof \think\Collection || $replyList instanceof \think\Paginator): if( count($replyList)==0 ) : echo "" ;else: foreach($replyList as $key=>$v3): if($v3['parent_id']  == $v['comment_id']): ?>
