<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./application/admin/view2/index/index.html";i:1505347690;s:45:"./application/admin/view2/public/menubox.html";i:1495107356;s:42:"./application/admin/view2/public/left.html";i:1505349142;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="admincp-header">
 ...
 <!--  <h2 style="cursor:pointer;">互利商城管理中心</h2>  -->
...
<!--      <li data-param="mobile"><a href="javascript:void(0);">模板</a></li>-->
  ...
  <div class="admincp-header-r">
    <div class="manager">
      ...
      <dl>
        <dt class="name">互利商城公测版</dt>
        <dd class="group">1.0测试版</dd>
      </dl>    
      <dl>
...
<div class="admincp-container-left">
    ...
    <?php endforeach; endif; else: echo "" ;endif; ?> 
    <div class="about" title="关于系统" onclick="ajax_form('about', '', 'http://www.tpshop.cn/admin/index.php?act=aboutus&op=index', 640);"><i class="fa fa-copyright"></i><span>互利物联</span></div>
</div>
