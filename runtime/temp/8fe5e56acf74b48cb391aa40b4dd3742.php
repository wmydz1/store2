<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"./application/admin/view2/order/ajax_return_list.html";i:1495107356;}*/ ?>
<table>
 	<tbody>
  	...
  	<tr>
        ...
        <td align="center" abbr="article_show" axis="col5" class="">
          <div style="text-align: center; width: 100px;" class="">
          		<?php if($items[type] == 0): ?>退货<?php endif; if($items[type] == 1): ?>换货<?php endif; ?>
           </div>
        </td>
        ...
        <td align="center" abbr="article_time" axis="col6" class="">
          <div style="text-align:left; width: 100px;" class="">
                <?php if($items[status] == -2): ?>已取消<?php endif; if($items[status] == -1): ?>审核不通过<?php endif; if($items[status] == 0): ?>待审核<?php endif; if($items[status] == 1): ?>审核通过<?php endif; if($items[status] == 2): ?>已发货<?php endif; if($items[status] == 3): ?>已完成<?php endif; ?>
          </div>
        </td>
        <td align="center" abbr="article_time" axis="col6" class="">
          <div style="text-align: left; width: 120px;" class="">
             ...
             <a class="btn red" href="javascript:void(0);" data-url="<?php echo U('Admin/order/return_del',array('id'=>$items['id'])); ?>" onclick="delfunc(this)"   id="button-delete6" ><i class="fa fa-trash-o"></i>删除</a></td>
          </div>
        </td>
